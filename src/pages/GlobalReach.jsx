    ...
    <Container maxW="1200px" py={[5, 10]}>
      <VStack spacing={[5, 10]}>
        ...
        <SimpleGrid columns={[1, null, 2]} spacing={[5, 10]} w="full">
          ...
          <Box >
            <Image src='/food-site/map.JPG'></Image>
          </Box>
        </SimpleGrid>
        <Divider ></Divider>
        <Box w="full">
        ...
        <Box w="full">
          ...
          <SimpleGrid columns={[2, null, 4]} spacing={5}>
            <Image src="/food-site/partners/costco.jpg" alt="US Partner" h={'60px'}/>
            <Image src="/food-site/partners/publix.jpg" alt="France Partner" h={'60px'}/>
            <Image src="/food-site/partners/Tesco.jpg" alt="UK Private Label" h={'60px'}/>
            <Image src="/food-site/partners/wellcome.jpg" alt="Leading Israeli Chain" h={'60px'}/>
          </SimpleGrid>
        </Box>
      </VStack>
    </Container>
