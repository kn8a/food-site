      ...
      <VStack spacing={[5, 10]}>
        ...
        <Box w='full'>
          ...
          <SimpleGrid columns={[2, null, 4]} spacing={5}>
            <Image
              src='/food-site/partners/costco.jpg'
              alt='US Partner'
              h={"60px"}
            />
            <Image
              src='/food-site/partners/publix.jpg'
              alt='France Partner'
              h={"60px"}
            />
            <Image
              src='/food-site/partners/Tesco.jpg'
              alt='UK Private Label'
              h={"60px"}
            />
            <Image
              src='/food-site/partners/wellcome.jpg'
              alt='Leading Israeli Chain'
              h={"60px"}
            />
          </SimpleGrid>
        </Box>
